...
conn.welcome = '*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ 😘مࢪحبا بڪ معنا فالڪروب/𝙰* \n*║*\n*╟❧ لوصف ديال لمجموعة😘:*\n\n@desc\n\n*║*\n*╟❧ 𝙳𝙸𝚂𝙵𝚁𝚄𝚃𝙰 𝚃𝚄 𝙴𝚂𝚃𝙰𝙳𝙸𝙰!!*\n*╚══════════════*'
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ طهلا/ي ماترجعش باقي هنا😂😂 👋🏻* \n*╚══════════════*'
...
let bio = `🤖 تم صنع هادا البوت من طࢪف @/ابـلـيـس الـمـلـڪـي🤴🏻⃟⃢🌹: ${uptime} ┃ `
...
return [d, ' nhar ️', h, ' sa3a ', m, ' d9i9a ', s, ' Segundo(s) '].map(v => v.toString().padStart(2, 0)).join('')}
_quickTest()
